...
// configuration step. It creates a namespace called `CameraSDK`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", CameraSDK::cmake::project_name, CameraSDK::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", CameraSDK::cmake::project_version);
      return EXIT_SUCCESS;
    }
